//write test for count of resolved topics in a category
...
describe('GET /api/categories/:cid/unresolved-count', () => {/*check that count of unresolved topics in a category is correct*/
    let adminUid;
    let regularUid;
    let categoryObj;
    let topicData;
